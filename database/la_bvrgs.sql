...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 09, 2023 at 04:53 PM
...
(3, 'CHONY MANIBALE OR', NULL, 'BLK 110 LOT 17 M.H DELPILAR', '09062481779', 2, '2023-01-07 12:25:06', NULL, NULL, NULL);
...
(74, 33, 1, 'San Miguel Apple', 6, 720.000, 'SanMigApple.png');
...
(82, 33, 'San Miguel Apple', 136254889, 1, 6, 720, '2023-04-06 15:22:31', NULL, 1),
(83, 26, 'Red Horse Big', 136254889, 1, 4, 550, '2023-04-06 15:22:32', NULL, 1);
...
--
ALTER TABLE `holdorder_tbl`
  MODIFY `holdOrder_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;
...
--
ALTER TABLE `pendingorder_tbl`
  MODIFY `pendingOrder_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=84;

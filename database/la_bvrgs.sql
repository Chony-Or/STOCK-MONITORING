...
--
-- Host: 127.0.0.1
-- Generation Time: May 31, 2023 at 10:04 AM
...
(1, 33, 1, 'San Miguel Apple', 6, 720.000, 'SanMigApple.png');
...
--
ALTER TABLE `holdorder_tbl`
  MODIFY `holdOrder_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 04, 2023 at 08:52 PM
...
(1, 1, 1, 33, 'San Miguel Apple - 136254889', 'Out for Delivery', '2023-06-05 02:19:08'),
(2, 1, 2, 26, 'Red Horse Big - 136254889', 'Out for Delivery', '2023-06-05 02:19:08'),
(4, 22, 97, 12, 'Coke 1.5 - 661778620', 'In Process', '2023-06-05 02:21:02');
...
--
ALTER TABLE `notification_tbl`
  MODIFY `notif_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

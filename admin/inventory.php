...
<body>
    ...
    <section class="home-section">
        ...
        $stmt = $conn->prepare('SELECT * FROM product_tbl ORDER BY product_id DESC LIMIT ?,?');
                ...
                <div class="products content-wrapper">
                    ...
                    <div class="products-wrapper">
                        ...
                        <a href="index.php?page=product&id=<?= $product['product_id'] ?>" class="product">
                            <img src="imgs/<?= $product['product_picture'] ?>" width="200" height="200" alt="<?= $product['product_name'] ?>">
                            <span class="name">

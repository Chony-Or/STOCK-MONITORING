        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="product_edit.php">
                    <div class="mb-3">
                        <label for="image" class="form-label">Choose Image</label>
                        <input class="form-control" type="file" name="image" value="<?= $product['product_picture'] ?>">
                    </div>
                    <div class="mb-3">
                        <label for="title" class="form-label">Product Name</label>
                        <input type="text" class="form-control" name="product" value="<?= $product['product_name'] ?>">
                    </div>
                    <div class="mb-3">
                        <label for="code" class="form-label">Product Code</label>
                        <input type="text" class="form-control" name="code" value="<?= $product['product_code'] ?>">
                    </div>
                    <div class="mb-3">
                        <label for="price" class="form-label">Price</label>
                    ...
                    <div class="mb-3">
                        <label for="category" class="form-label">Category</label>
                        <select class="form-select" name="category" value="<?= $product['product_class'] ?>">
                            <?php foreach ($all_categories as $row) : ?>
                                <option value="<?php echo $row["productClass_id"]; ?>">
                                    <?php echo $row["product_class"]; ?>
                                </option>

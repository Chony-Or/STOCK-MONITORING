...
<body>
        ...
        <ul class="cd-tabs__panels">
            ...
            <li id="tab-admin" class="cd-tabs__panel cd-tabs__panel--selected text-component">
                <div class="table-responsive">
                    <a href="#addnew" class="btn btn-primary" data-toggle="modal"><span><i
                                class='bx bxs-user-plus'></i></i></span></a>
                    <?php
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="#change_password_<?php echo $row['admin_id']; ?>"
                                        class="btn btn-primary btn-sm" data-toggle="modal">
                                        <span> <i class='bx bxs-key'></i> </span>
                                    </a>
            ...
            <li id="tab-regular" class="cd-tabs__panel text-component">
                <div class="table-responsive">
                <a href="#add_regular" class="btn btn-primary" data-toggle="modal"><span><i
                                class='bx bxs-user-plus'></i></i></span></a>
                    <?php
                                if (isset($_SESSION['message'])) {
                                ?>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="#change_password_<?php echo $row['customer_id']; ?>"
                                        class="btn btn-primary btn-sm" data-toggle="modal">
                                        <span> <i class='bx bxs-key'></i> </span>
                                    </a>
    ...
    <?php include('regular_add_modal.php'); ?>
    <?php include('user_password_modal.php'); ?>

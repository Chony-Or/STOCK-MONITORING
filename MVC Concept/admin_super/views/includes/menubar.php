    ...
    <header class="header">
        ...
        <div class="container-fluid header__container">
            ...
            <img src="../additionals/images/InitialLogo.png" alt="Logo Image" class="header__img">
        ...
        <nav class="nav__container">
            ...
            <div>
                ...
                <a href="#" class="nav__link nav__logo">
                    ...
                    <span class="nav__logo-name"> L </span>
                </a>
                ...
                <div class="nav__list">
                    ...
                    <div class="nav__items">
                        ...
                        <!-- Dashboard Link-->
                        <a href="index.php?controller=dashboard&action=index" class="nav__link">
            ...
            <!-- Logout -->
            <a href="views/includes/logout.php" class="nav__link nav__logout">

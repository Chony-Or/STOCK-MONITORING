            ...
            <div class="container py-1">
                ...
                <div class="user text-center">
                    ...
                    <div class="col-lg-12 mx-auto">
                        ...
                        <h1> <b> Guest Customer </b> </h1>
                        <p> Add, Edit and Delete of data of the Guest Customer </p>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($users as $user) : ?>
                                    ...
                                    <!-- Add -->
                                    <div class="modal fade" id="add_guest" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <!-- Add Form -->
                                                    <form method="POST" action="request/user_guest_add.php">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <textarea class="form-control" name="guest_address_hn" id="address_hn" users="1" oninput="capitalizeFirstLetter(this)"></textarea>
                                                        </div>

                                                        <div class="mb-3">
                                                            <label for="address_st" class="form-label">Street</label>
                                                            <textarea class="form-control" name="guest_address_st" id="address_st" users="1" oninput="capitalizeFirstLetter(this)"></textarea>
                                                        </div>

                                                        <div class="mb-3">
                                                            <label for="address_city" class="form-label">City</label>
                                                            <textarea class="form-control" name="guest_address_city" id="address_city" users="1" oninput="capitalizeFirstLetter(this)"></textarea>
                                                        </div>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="password" class="form-control" name="guest_password" id="password">
                                                        </div>
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <!-- Modal Edit Form -->
                                                    <form method="POST" action="request/user_guest_edit.php?id=<?php echo $user['customer_id']; ?>">
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="request/user_guest_delete.php?id=<?php echo $user['customer_id']; ?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Yes</a>
                                                </div>

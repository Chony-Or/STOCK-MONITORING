...
(1, 33, 1, 1, 6, 720.000, 'Out for Delivery', '2023-06-05 02:19:08', NULL),
(2, 26, 1, 2, 4, 550.000, 'Out for Delivery', '2023-06-05 02:19:08', NULL),
(4, 12, 22, 97, 1, 714.000, 'Out for Delivery', '2023-06-05 02:21:02', NULL);
...
--
ALTER TABLE `on_processorder_tbl`
  MODIFY `activeOrder_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 04, 2023 at 07:53 PM
...
(1, 22, 97, 58, 'Zest - O Choco - 536001727', 'In Process', '2023-06-05 01:52:29'),
(2, 22, 98, 27, 'Red Horse Small - 536001727', 'In Process', '2023-06-05 01:52:29');
...
(1, 58, 22, 97, 1, 185.000, 'Out for Delivery', '2023-06-05 01:52:29', NULL),
(2, 27, 22, 98, 1, 540.000, 'Out for Delivery', '2023-06-05 01:52:29', NULL);
...
(93, 26, 'Red Horse Big', 605747866, 23, 4, 550, '2023-04-20 11:18:17', 1),
(94, 7, 'Absolute 6L', 605747866, 23, 3, 218, '2023-04-20 11:18:17', 1),
(95, 12, 'Coke 1.5', 200729181, 0, 3, 714, '2023-05-08 16:35:53', 1),
(96, 21, 'Mountain Dew Small', 690087276, 0, 2, 169, '2023-05-08 21:12:26', 1);
...
(27, 4, 540.000, 'Red Horse Small', 18, '500 ml per piece\n12 pieces per purchase', 'RHS', 'RhSmall.png', '0000-00-00 00:00:00', '2023-06-05 01:52:29', 1),
...
(58, 2, 185.000, 'Zest - O Choco', 18, '250 ml per piece\n10 pieces per purchase', 'ZST-CHC', 'Zest-oChoco.png', '0000-00-00 00:00:00', '2023-06-05 01:52:29', 1),
...
--
ALTER TABLE `holdorder_tbl`
  MODIFY `holdOrder_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;
...
--
ALTER TABLE `pendingorder_tbl`
  MODIFY `pendingOrder_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=99;
